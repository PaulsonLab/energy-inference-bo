...
| `src/energy_bo/local_process/` | deterministic local geometry, Gaussian/Vecchia conditionals, affine local energies, and oracle truths | working on the bounded Task 04A process-level model or a separately approved successor |
