...
%   Rigorous symmetry inference construction:    THEORY READY --- PROSPECTIVE PILOT REQUIRED
...
\paragraph{Status.}
\textbf{THEORY READY --- PROSPECTIVE PILOT REQUIRED.}  The construction below
...
claimed as sampler novelty.  The remaining blocker is the locked prospective
test of whether the resulting finite-sample allowance is numerically small
enough for a sparse end-to-end T3 certificate.
...
\begin{description}
    ...
    \item[Inference] The exact rejection-sampling and whitened finite-sample
          construction is complete.  \textbf{THEORY READY --- PROSPECTIVE
          PILOT REQUIRED}; empirical end-to-end status remains open until the
          locked pilot is run.
